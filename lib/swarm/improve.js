...
export function improvePrompt({ text, kind, title, business, tickets, quotes, isArticle, plan = "" }) {
...
WHAT IT IS: ${k.context}${plan ? `
${plan}
Rewrite TOWARDS that plan: open with what the reader is trying to do, show this as one of the ways, then the reason it works. Never open by naming the product.` : ""}
