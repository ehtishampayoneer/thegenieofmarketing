...
const CHANNEL = { reddit: "reddit", quora: "quora", reply: "reddit", email: "email", winback: "email", pitch: "email", social: "x", article: "blog", listing: "blog" };
const IDEAL = { reddit: [60, 260], quora: [120, 400], reply: [40, 220], email: [40, 160], winback: [40, 170], pitch: [35, 200], social: [8, 70], article: [600, 3000], listing: [30, 250] };
...
// ── The AI judge ─────────────────────────────────────────────────────────────
export function judgePrompt({ text, kind, title, business, people }) {
