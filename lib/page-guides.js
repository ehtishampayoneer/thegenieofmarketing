...
export const PAGE_GUIDES = {
  ...
  approvals: {
    ...
    steps: [
      ...
      { icon: "growth", title: "Approve → it goes live", text: "Genie publishes to your site (or a hosted page) and instantly gets it indexed by Google." },
    ],
  ...
  aisearch: {
    ...
    steps: [
      ...
      { icon: "write", title: "Writes the page to win the citation", text: "An answer page built to become the source AI quotes — dropped straight into Approvals." },
    ],
  ...
  connections: {
    ...
    steps: [
      { icon: "link", title: "Connect Google", text: "Unlocks live rankings, hours-not-weeks indexing, and sending outreach from your own Gmail." },
