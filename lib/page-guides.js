...
export const PAGE_GUIDES = {
  ...
  site: {
    name: "Website Setup", icon: "globe",
    what: "Genie scans your own website and hands you the exact, copy-paste fixes that make it rank-ready — so all the content and links Genie builds pay off faster. Genie never edits your site; it recommends, you apply.",
    use: [
      "Enter your website address and hit “Scan my site”.",
      "Work down the list — green means done, the rest are quick wins. Click any item to open its ready-made snippet.",
      "Copy each snippet into your site's <head> (or hand this page to whoever manages your site). Re-scan to watch your readiness score climb.",
    ],
    steps: [
      { icon: "scan", title: "Genie scans your site", text: "It reads your homepage and checks the SEO + AI-answer foundations: titles, meta, structured-data badges, sitemap and more." },
      { icon: "write", title: "It writes the fixes", text: "For anything missing, Genie generates the exact code — filled in with your business name, keywords and URL — ready to paste." },
      { icon: "growth", title: "You paste, it compounds", text: "A rank-ready site means every article and link Genie builds ranks faster and gets recommended by AI sooner." },
    ],
    genie: "Audits your site and writes the exact fixes.",
    you: "Paste the snippets in (or forward them to your developer).",
    benefit: "Removes the #1 thing slowing your growth — a weak site — so Genie's work ranks faster.",
  },
  markets: {
    name: "Market Testing", icon: "megaphone",
    what: "Genie finds countries you can genuinely serve where demand is real and competition is thin, then lets you TEST each one — a localized page + tracked search results — before you commit. It's market testing, not a promise of growth.",
    use: [
      "Set “I can serve” at the top — anywhere, some regions, or only your area (local businesses are skipped, honestly).",
      "Scan the board: flag, difficulty, projected traffic + sales, and a time/progress bar for each country. Green dots are Verified from your Search Console; the rest are estimates.",
      "Open a promising market to see the 30-day play, then “Run this as a 30-day experiment” to validate it before scaling.",
    ],
    steps: [
      { icon: "scan", title: "Finds serve-able markets", text: "It uses your real Search Console country data plus market signals to spot low-competition countries you can actually sell to." },
      { icon: "growth", title: "Projects the upside", text: "Traffic, sales, difficulty and time-to-win per country — verified where there's data, clearly estimated where there isn't." },
      { icon: "flag", title: "Tests before it scales", text: "Each market runs as a tight 30-day experiment — one localized page, a few useful assets, one goal. Scale only what produces leads." },
    ],
    genie: "Finds, ranks and tests new-country opportunities.",
    you: "Pick a market and approve the experiment.",
    benefit: "Opens low-competition markets where you can start earning quickly — before competitors notice them.",
  },
  approvals: {
  ...
  hunt: {
    ...
    use: [
      ...
      "Optional: tap a rival under the “Poach from rivals” box (Genie named them when it read your site, so check them), or type your own, to hunt people wanting an alternative to them.",
  ...
  prospects: {
    ...
    use: [
      "Tap one of the targets under the box — taken from who your own site says you sell to — or type your own (e.g. “dental clinics in Texas”).",
    ...
    you: "Pick who to target and send the pitches.",
  ...
  featured: {
    ...
    use: [
      "Tap one of the niches under the box — Genie built them from your own website — or type your own.",
    ...
    you: "Pick a niche and send the outreach.",
