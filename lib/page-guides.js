...
export const PAGE_GUIDES = {
  ...
  sprint: {
    ...
    steps: [
      { icon: "target", title: "Pick one customer + one offer", text: "You commit to the single customer type most likely to buy, and the one offer you'll pitch. Specific beats broad." },
      { icon: "crosshair", title: "Run the fast-money engine for 30 days", text: "Genie hunts buyers, finds clients, and recovers old leads while you approve and send. This page keeps score." },
      { icon: "check", title: "Get a plain verdict at day 30", text: "It tracks the 7 numbers that matter and tells you: scale it, tweak one thing, or fix the offer — no guessing." },
    ],
