...
export const PAGE_GUIDES = {
  ...
  markets: {
    name: "Market Expansion", icon: "megaphone",
    what: "Genie finds countries you can genuinely serve where demand is real and competition is thin — then ranks them by opportunity with projected traffic, sales and how long each takes to win.",
    use: [
