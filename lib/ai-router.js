...
const PROVIDERS = [
  ...
  {
    // GitHub Models: free with any GitHub account (a fine-grained token with the
    // "Models" permission). Low daily limits, but free.
    name: "github",
    priority: 6,
    apiKey: () => process.env.GITHUB_MODELS_TOKEN,
    model: () => process.env.GITHUB_MODELS_MODEL || "openai/gpt-4.1-mini",
    rpm: 15,
    call: (cfg, payload) => callOpenAICompatible("https://models.github.ai/inference", cfg, payload),
  },
  {
...
// ---------------------------------------------------------------------------
const DEFAULT_BUDGET = { gemini: 1400, groq: 14000, openrouter: 1000, cerebras: 5000, mistral: 5000, github: 150, cloudflare: 300, "openrouter-paid": Infinity, paid: Infinity };
