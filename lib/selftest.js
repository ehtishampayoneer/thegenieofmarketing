    ...
    run: async () => {
      ...
      try {
        ...
        if (p === "mistral" && /429|rate.?limit/i.test(a)) {
          return warn("Mistral accepted the key but is limiting requests right now (429).", "The key is fine. On Mistral's free plan, verify your phone number once (admin.mistral.ai → Organization or Subscription). New keys can also take a few minutes to activate. Genie keeps using the other free services meanwhile.");
        }
