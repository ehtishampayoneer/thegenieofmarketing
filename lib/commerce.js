...
export const PROVIDERS = {
  stripe: {
    ...
    steps: [
      ...
      "Under 'Select events', add checkout.session.completed and payment_intent.succeeded.",
      "Save, then click 'Send test webhook' — the status below will confirm it arrived.",
    ],
  ...
  shopify: {
    ...
    steps: [
      "In Shopify admin, open Settings → Notifications → Webhooks.",
      "Create a webhook: Event = 'Order payment', Format = JSON.",
      "Paste the URL above as the callback URL and save.",
      "Shopify sends a verification on save — the status below will confirm it arrived.",
    ],
  ...
  paddle: {
    ...
    steps: [
      "In Paddle, open Developer Tools → Notifications → New destination.",
      "Paste the URL above as the destination.",
      "Subscribe to the 'transaction.completed' event and save.",
    ],
    verify(raw, headers, secret) {
  ...
  lemonsqueezy: {
    ...
    steps: [
      "In Lemon Squeezy, open Settings → Webhooks → Add endpoint.",
      "Paste the URL above as the callback URL.",
      "Select the 'order_created' event and save.",
    ],
