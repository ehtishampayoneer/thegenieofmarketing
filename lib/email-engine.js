...
// away, so a database that rejects every insert looked exactly like a niche
// with nobody in it — for as long as it took someone to read the schema by hand.
// A refusal by the database is not an empty niche, and it gets recorded.
