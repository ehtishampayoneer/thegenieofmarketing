...
//
// IT DOES NOT FOLLOW UP. `outreach_log.is_followup` exists and this comment used
// to claim follow-ups were scheduled; nothing has ever written or read that
// column. A first cold email gets a reply 1-3% of the time and two follow-ups
// roughly double that, so sending once and stopping throws away half the results
// of the channel Genie leads with. Building that is the largest real gap in the
// outreach path — see the rebuild map.
