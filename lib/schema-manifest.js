...
export const SCHEMA_MANIFEST = {
  action_outcomes: [],
  actions: ["created_at","id","payload","priority","result","scan_id","status","target","title","type","user_id"],
  activity: ["created_at","detail","message","user_id","verb"],
  ...
  connections: ["access_token","account_email","created_at","google_email","gsc_site","id","meta","provider","refresh_token","scope","scopes","user_id"],
  ...
  events: ["actor","created_at","data","host","id","subject","type"],
  ...
  placements: ["created_at","draft","host","id","keyword","kind","meta","next_eligible_at","platform","status","target_title","target_url","user_id"],
