...
export const SCHEMA_MANIFEST = {
  ...
  directory_contacts: ["company","domain","email","id","industry","is_genie_lead"],
  ...
  keywords: ["ai_cited","competition","coverage","gsc_clicks","gsc_impressions","health","host","id","keyword","priority","source","traffic_potential","user_id","volume"],
  links: ["channel","host","id","ref","url","user_id"],
  notifications: ["created_at","id","kind","priority","status","user_id"],
  outreach_log: ["body","contact_email","contact_name","created_at","followup_step","host","id","is_followup","replied_at","sent_at","source","status","subject","user_id"],
