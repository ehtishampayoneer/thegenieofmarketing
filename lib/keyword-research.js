...
Return ONLY: {"keywords":[{"keyword":"...","volume":1200,"competition":45,"difficulty":"medium","cpc":1.20,"trend":"up","intent":"commercial","isQuestion":false}]}`,
    ...
    for (const k of keywords) {
      ...
      // NO fabricated rank or trend line. A ranking is a MEASUREMENT, not a guess —
      // it only ever comes from Google Search Console (lib/keyword-sync.js). Inventing
      // a "believable" number here becomes a lie the moment the owner checks their real
      // rank, and it would poison trust in the honest estimates above.
      k.ranking = null;
      k.rankChange = 0;
    }
