...
Return ONLY: {"keywords":[{"keyword":"...","volume":1200,"competition":45,"difficulty":"medium","cpc":1.20,"trend":"up","intent":"commercial","isQuestion":false}]}`,
    ...
    // opportunity = volume-weighted, competition-discounted. Higher = better pick.
    for (const k of keywords) {
      const volScore = Math.min(100, Math.log10(Math.max(10, k.volume)) * 22); // 10->22, 1k->66, 100k->110cap
