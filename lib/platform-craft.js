...
export const PLATFORMS = {
  ...
  gbp: {
    ...
    fold: 100,
    rules: [
      "About 100 characters show before 'Read more', so the offer or the news has to be in the first line.",
      "Local and concrete. Name the area, the season, the actual thing happening.",
      "This is read by someone already looking at the business on a map, so skip the introduction and get to what is new or available.",
      "End on one plain action: book, call, visit, order.",
      "No hashtags. They do nothing here.",
    ],
  },
  tiktok: {
    label: "TikTok",
