...
const PLAYS = [
  ...
  { id: "broken", label: "Fix their broken links", blurb: "Pages linking to something dead. You report it and offer a replacement. The highest reply rate of any link outreach.", icon: "link" },
