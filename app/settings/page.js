...
export default function SettingsPage() {
  const [f, setF] = useState({ company_name: "", company_pitch: "", company_website: "", company_phone: "", company_address: "", sender_name: "", sender_email: "" });
...
function clean(p) {
  const out = {};
  for (const k of ["company_name", "company_pitch", "company_website", "company_phone", "company_address", "sender_name", "sender_email"]) out[k] = p?.[k] || "";
  return out;
}
